...
export function Hero(){
  return (
    <section 
      className="w-full h-[600px] flex items-center bg-gray-100 flex-col bg-cover bg-center relative"
      style={{ backgroundImage: "url('/hero1.jpg')" }}
    > 

    <div className="absolute inset-0 bg-black opacity-40"></div>

      <h2 className="mt-20 text-5xl z-10 text-white font-bold">Auto Lux</h2>
